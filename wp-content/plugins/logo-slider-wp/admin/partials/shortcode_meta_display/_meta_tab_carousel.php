...
$this->meta_form->number(
    array(
        ...
        'desc'    => __( 'Duration of transition between slides (in ms). Default value is 750.', $this->plugin_name ),
...
$this->meta_form->select(
    array(
        'label' => __( 'Slide Item Vertical Align', $this->plugin_name ),
...
$this->meta_form->select(
    array(
        ...
        'options'   => array(
            ...
            'vertical_center' => __( 'Vertical Center', $this->plugin_name ),
...
$this->meta_form->text(
    array(
        'label'     => __( 'Nav Button Line Height', $this->plugin_name ),
        'desc'      => __( 'Set Line Height for navigation button.', $this->plugin_name ),
        'name'      => 'meta_lgx_lsp_shortcodes[lgx_carousel_nav_btn_line_height]',
        'id'        => 'lgx_carousel_nav_btn_line_height',
        'status'  => LGX_LS_PLUGIN_META_FIELD_PRO,
        'default'   => '24px'
    )
);
...
$this->meta_form->text(
    array(
        ...
        'desc'      => __( 'Set Width for navigation button.', $this->plugin_name ),
...
$this->meta_form->text(
    array(
        ...
        'desc'      => __( 'Set Height for navigation button.', $this->plugin_name ),
...
$this->meta_form->text(
    array(
        ...
        'desc'      => __( 'Set padding for navigation button.', $this->plugin_name ),
...
$this->meta_form->text(
    array(
        ...
        'desc'      => __( 'Set carousel Border Radius for navigation button.', $this->plugin_name ),
