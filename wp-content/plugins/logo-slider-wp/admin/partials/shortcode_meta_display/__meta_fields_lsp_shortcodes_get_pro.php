<ul class="lgx-inline lgx-admin-list-get-pro">
    <li>
        <div class="circle-wrapper">
            ...
            <div class="lgx-pro-icon">
                ...
                <?php else: ?>
                <a href="http://logichunt.net/docs/wordpress-logo-slider/" target="_blank" ><span>Usage</span></a>
                <?php endif; ?>
            </div>
        </div>
    </li>
    ...
    <li class="lgx_hide_md">
        <div class="circle-wrapper">
            ...
            <div class="lgx-pro-icon">
                <a href="http://logichunt.net/wpdemo/wordpress-logo-slider/" target="_blank" ><span>Demo</span></a>
            </div>
        </div>
    </li>
