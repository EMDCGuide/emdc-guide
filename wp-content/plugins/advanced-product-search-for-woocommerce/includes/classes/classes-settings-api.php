...
class APSW_Settings_API {
    ...
    function __construct() {
        $this->settings_api = new WeDevs_Settings_API_Search;
    ...
    function get_settings_sections() {
        $sections = array(
			...
			array(
                'id'    => 'apsw_license',
                'title' => esc_html__( 'License', 'apsw-lang' )
            ),
    ...
    function get_settings_fields() {
        ...
        $settings_fields = array(
            'apsw_search_form' => array(
				 ...
				 array(
                    'name'    => '__search_by',
                    'label'   => esc_attr__( 'Search By', 'apsw-lang' ),
                    'desc'    => esc_html__( 'Search by query work as default search functions of WooCommmerce and WordPress ', 'apsw-lang' ),
                    'type'    => 'radio',
                    'options' => array(
                        'query' => 'Product Query',
                        'tags'  => 'Product Tags',
					...
					'default' => esc_attr( $form['__search_by'] ),
				...
				array(
                    ...
                    'label'             => esc_attr__( 'All Categories', 'apsw-lang' ),
                    'desc'              => esc_html__( 'Text for All Categories.', 'apsw-lang' ),
                    'placeholder'       => esc_attr( $form['search_btn'] ),
                    'type'              => 'text',
                    'default'           => esc_attr( $form['all_category_text'] ),
                    'sanitize_callback' => 'sanitize_text_field'
                ),
				...
				array(
                    'name'    => 'how_to_use',
                    'label'   => esc_attr__( "How to use", 'apsw-lang' ),
                    'desc'    => esc_html__( 'You can use as widgets , please check inside widget area or use the Shortcode [apsw_search_bar_preview] ', 'apsw-lang' ),
                    'type'    => 'html',
            ...
            'apsw_search_results' => array(
               ...
               array(
				...
				array(
                    ...
                    'label'   => esc_attr__( "Show add to cart button", 'apsw-lang' ),
                    'desc'    => esc_html__( 'Show product add to cart button.', 'apsw-lang' ),
                    'type'    => 'radio',
                    'options' => array(
                        'yes' => 'Yes',
                        'no'  => 'No'
                    ),
					'default'     	 	=> esc_attr( $result['show_add_to_cart'] ),
					'sanitize_callback' => 'sanitize_text_field'
                ),
				array(
                    'name'    => 'show_price',
