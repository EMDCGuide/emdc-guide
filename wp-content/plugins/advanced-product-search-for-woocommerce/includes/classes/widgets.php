            ...
            'form_fields' => array(
				...
				'search_bar_style' => array(
					...
					'options' => array( // Required
						...
						'2' => esc_html__( 'Style 2', 'apsw-lang' ),
						'3' => esc_html__( 'Style 3', 'apsw-lang' ),
						'4' => esc_html__( 'Style 4', 'apsw-lang' ),
						'5' => esc_html__( 'Style 5', 'apsw-lang' ),
						'6' => esc_html__( 'Style 6', 'apsw-lang' ),
					),
