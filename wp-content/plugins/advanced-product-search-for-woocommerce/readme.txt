...
Advanced Product search for woocommerce – powerful live search plugin for WooCommerce.You just got to install and simply begin typewriting and you'll instantly see the product list that you simply search.

It creates a simple search box that shows you instant search results, by suggesting you product from your WooCommerce store that match your search out criteria.
