...
namespace com\cminds\registration\addon\approvenewusers\view;
...
abstract class SettingsViewAbstract {
	...
	public function renderCategory($category) {
		...
		return '<div class="settings-category settings-category-'. $category .'">'. apply_filters('cmreganu-settings-category', $result, $category) .'</div>';
	}
	...
	public function renderSubcategory($category, $subcategory) {
		...
		return '<div class="settings_'. $category .'_'. $subcategory .'">'. apply_filters('cmreganu-settings-subcategory', $result, $category, $subcategory) .'</div>';
	}
